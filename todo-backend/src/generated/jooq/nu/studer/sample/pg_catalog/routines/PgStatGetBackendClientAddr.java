...
public class PgStatGetBackendClientAddr extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_backend_client_addr.RETURN_VALUE</code>.
     */
    ...
    public PgStatGetBackendClientAddr() {
        super("pg_stat_get_backend_client_addr", PgCatalog.PG_CATALOG, SQLDataType.VARCHAR);
