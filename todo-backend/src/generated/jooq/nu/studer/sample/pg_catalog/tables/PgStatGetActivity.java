...
public class PgStatGetActivity extends TableImpl<PgStatGetActivityRecord> {
     ...
     */
    public final TableField<PgStatGetActivityRecord, OffsetDateTime> XACT_START = createField(DSL.name("xact_start"), SQLDataType.TIMESTAMPWITHTIMEZONE, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_get_activity.query_start</code>.
     */
    public final TableField<PgStatGetActivityRecord, OffsetDateTime> QUERY_START = createField(DSL.name("query_start"), SQLDataType.TIMESTAMPWITHTIMEZONE, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_get_activity.backend_start</code>.
     */
    public final TableField<PgStatGetActivityRecord, OffsetDateTime> BACKEND_START = createField(DSL.name("backend_start"), SQLDataType.TIMESTAMPWITHTIMEZONE, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_get_activity.state_change</code>.
     */
    public final TableField<PgStatGetActivityRecord, OffsetDateTime> STATE_CHANGE = createField(DSL.name("state_change"), SQLDataType.TIMESTAMPWITHTIMEZONE, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_get_activity.client_addr</code>.
     */
    public final TableField<PgStatGetActivityRecord, String> CLIENT_ADDR = createField(DSL.name("client_addr"), SQLDataType.VARCHAR, this, "");
