...
public class JsonbEachRecord extends TableRecordImpl<JsonbEachRecord> implements Record2<String, String> {
    ...
    @Override
    public JsonbEachRecord value2(String value) {
        setValue(value);
        return this;
    }

    @Override
    public JsonbEachRecord values(String value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public JsonbEachRecord(String key, String value) {
        super(JsonbEach.JSONB_EACH);
