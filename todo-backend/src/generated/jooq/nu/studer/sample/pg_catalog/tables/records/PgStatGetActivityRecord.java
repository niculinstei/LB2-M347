...
public class PgStatGetActivityRecord extends TableRecordImpl<PgStatGetActivityRecord> {
     ...
     */
    public PgStatGetActivityRecord(Long datid, Integer pid, Long usesysid, String applicationName, String state, String query, String waitEventType, String waitEvent, OffsetDateTime xactStart, OffsetDateTime queryStart, OffsetDateTime backendStart, OffsetDateTime stateChange, String clientAddr, String clientHostname, Integer clientPort, Long backendXid, Long backendXmin, String backendType, Boolean ssl, String sslversion, String sslcipher, Integer sslbits, String sslClientDn, BigDecimal sslClientSerial, String sslIssuerDn, Boolean gssAuth, String gssPrinc, Boolean gssEnc, Integer leaderPid, Long queryId) {
        super(PgStatGetActivity.PG_STAT_GET_ACTIVITY);
